...
int fix_timeout = 300, fix_interval = 2*3600; // Default intervals used for GPS fixing
...
static int8_t user_parse(uint8_t token)
{
	...
	/***
	 *
	 * Changes the default GPS mode either to TD_GEOLOC_OFF, or TD_GEOLOC_HW_BCKP or
...
void TD_USER_Setup(void)
{
	...
	// Delayed start, waiting for a command for 180 seconds
